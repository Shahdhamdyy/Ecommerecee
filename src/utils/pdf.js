...
function generateHeader(doc) {
  doc
    ...
    //ay haga ba3mlha bt2sr ala el ba3dah
    .fillColor("#444444")
    .fontSize(20)
    .text(" Buidly.", 110, 57)
    .fontSize(10)
    .text("BUILDLY.", 200, 50, { align: "right" })
    .text("123 Main Street", 200, 65, { align: "right" })
    .text("New York, NY, 10025", 200, 80, { align: "right" })
    .moveDown(); //ashan adkhol fl section el ba3do
}
...
function generateInvoiceTable(doc, invoice) {
  ...
  generateHr(doc, invoiceTableTop + 20); //HORIZONTAL LINE
  doc.font("Helvetica");
